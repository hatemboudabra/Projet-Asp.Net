...
namespace BibliothequeVieuxMontreal.Controllers
{
    public class LivresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Titre,Auteur,Pages,Cetegorie")] Livre livre)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Titre,Auteur,Pages,Cetegorie")] Livre livre)
        {
            if (id != livre.Id)
            {
                return NotFound();
