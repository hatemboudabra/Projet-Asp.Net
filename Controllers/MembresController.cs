...
namespace BibliothequeVieuxMontreal.Controllers
{
    public class MembresController : Controller
    {
        ...
        public MembresController(biblioContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nom,Prenom,Age")] Membre membre)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nom,Prenom,Age")] Membre membre)
        {
            if (id != membre.Id)
            {
                return NotFound();
